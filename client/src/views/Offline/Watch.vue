...
export default defineComponent({
    ...
    // 最初に実行（Watch コンポーネントの created より前）
    beforeCreate() {
    ...
    methods: {
        ...
        async init() {
            ...
            this.playerStore.recorded_program = this.createRecordedProgram(download);
        ...
        // オフライン保存メタデータから録画番組情報を組み立てる
        createRecordedProgram(download: OfflineDownloadMetadata): IRecordedProgram {
